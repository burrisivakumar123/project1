...
public class Time_EndToEnd_Delay_Results {
  ...
  String fname=null,fname1=null,fname2=null,fname3=null,fname4=null,fname5=null,fname6=null,fname7=null;
    	...
    	try
    	{
    		...
    		while(rs.next()==true)
    		{
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart3D("Robust defense scheme against selective drop attack in wireless Ad Hoc Networks", "End To End Time Dealy(Kbps) ", "Total End Time Dealy (Kbps)",
    	                dataSet, PlotOrientation.VERTICAL, true, true, true);
    	        ChartFrame chartFrame=new ChartFrame("Different Transaction End To End Time Delay Details",chart);

...
public class ViewNetwork3 extends JFrame implements ActionListener
{
...
setTitle("Network3 ::Robust defense scheme against selective drop attack in wireless Ad Hoc Networks");
c= getContentPane();
c.setLayout (null);
	 ...
	 heading.addElement("Node Name");
		...
		heading.addElement("Attacked");
			  ...
			  Dbcon db = new Dbcon();
	             ...
	             String query = "SELECT * From Network3 ";

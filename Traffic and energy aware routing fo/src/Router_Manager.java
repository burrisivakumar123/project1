...
public class Router_Manager implements ActionListener {
	JFrame jf;
	Container c;
	...
	Router_Manager() {
		jf = new JFrame("Router Manager :: Robust defense scheme against selective drop attack in wireless Ad Hoc Networks");
		c = jf.getContentPane();
		c.setLayout(null);
		
		c.setBackground(Color.WHITE);
		mbr = new MenuBar();
		file = new Menu("ROUTER MANAGER");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == b1) {
			...
			try {
				...
				heading.addElement("Traffic Node Name");
		...
		public void run() {
			...
			if (this.port == 309)
			{
				...
				try
				{
				    ...
				    connect.createStatement().executeUpdate("insert into ids values('"+node+"','"+ene+"','"+dt+"')");

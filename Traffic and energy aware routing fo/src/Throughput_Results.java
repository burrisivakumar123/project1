  ...
  String fname=null,fname1=null,fname2=null,fname3=null,fname4=null,fname5=null,fname6=null,fname7=null;
    	...
    	try
    	{
    		...
    		while(rs.next()==true)
    		{
    	        ...
    	        dataSet.setValue(c1, "TPT1", fname);
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart3D("Robust defense scheme against selective drop attack in wireless Ad Hoc Networks", "Througput(Kbps) ", "Total Throughput (Kbps)",
